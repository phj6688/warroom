...
If you have ANY question for the human (missing context, ambiguity in the problem, domain specifics, stakeholder preferences, constraints you can't infer), you MUST surface each one using EXACTLY this XML tag — one question per tag, anywhere in your response:
<need_human_input>your specific question</need_human_input>

Questions asked in natural prose or bullet lists without this tag will never reach the human. If you have no questions, omit the tag entirely.`;
