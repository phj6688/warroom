...
If you have ANY question for the human (missing context, ambiguity in the problem, domain specifics, stakeholder preferences, constraints you can't infer), you MUST surface each one on its own line using EXACTLY this format — not in prose, not in a bullet list:
NEED_HUMAN_INPUT: <your specific question>

Asking questions in natural prose without this marker means the human will never see them. If you have no questions, omit the marker entirely.`;
