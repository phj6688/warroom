...
if (UNAUTH_MODE) {
  log.warn('WAR_ROOM_TOKEN unset — running in UNAUTHENTICATED mode (homelab default). Set WAR_ROOM_TOKEN in .env to gate /api/* and the WebSocket upgrade.');
} else {
  log.info('WAR_ROOM_TOKEN configured — bearer auth enabled');
}
