...
function buildClassifierUserTurn(problem) {
  return 'Classify the problem statement below into exactly ONE archetype id from this closed list:\n' +
    ...
    '\n\nARCHETYPE is the category the problem belongs to, NOT your answer to it, and must be copied ' +
    ...
    'CONFIDENCE: <0.0-1.0>\n' +
    'SPECIALISTS: <up to 3 comma-separated domains from the list above, or none>\n' +
...
module.exports = { createFingerprintClassifier, buildClassifierUserTurn, VALID_ARCHETYPES };
